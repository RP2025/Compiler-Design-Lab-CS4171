...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_declarations = 14,              /* declarations  */
  YYSYMBOL_declaration = 15,               /* declaration  */
  YYSYMBOL_type_specifier = 16             /* type_specifier  */
};
...
static const char *const yytname[] =
{
  ...
  "function", "declarations", "declaration", "type_specifier", YY_NULLPTR
};
...
{
       9,    10,     1,     4,     5,     6,    14,    15,     7,    16,
       8,     0,     0,    17
};

static const yytype_int8 yycheck[] =
{
       4,     5,     4,     3,     0,     6,     9,    12,     7,     3,
       8,    -1,    -1,    10
};
...
{
       0,     4,    12,    13,     3,     0,     6,     7,     8,     4,
       5,    14,    15,    16,     9,    14,     3,    10
};

/* YYR1[RULE-NUM] -- Symbol kind of the left-hand side of rule RULE-NUM.  */
static const yytype_int8 yyr1[] =
{
       0,    11,    12,    13,    14,    14,    15,    16,    16
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 3: /* function: INT IDENTIFIER '(' ')' '{' declarations '}'  */
#line 39 "yacc_file.y"
                                                 { 
...
#line 52 "yacc_file.y"
                                   { 
        add_to_symbol_table((yyvsp[-1].id), (yyvsp[-2].id), "local");  // Add variable to symbol table
        printf("Declared variable: %s of type: %s\n", (yyvsp[-1].id), (yyvsp[-2].id));
    }
#line 1161 "y.tab.c"
    break;
